...
public class CSVFileGenerator {
    ...
    public static void main(String[] args) {
        CSVFileGenerator testDataGenerator = new CSVFileGenerator(5, 5, 10);
        testDataGenerator.writeToCSV("C:\\Users\\aston\\IdeaProjects\\my projects\\dimploma-mc\\additional\\rcsData\\estimateMatrix.csv", ",");
    }
}
