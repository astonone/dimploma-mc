...
public class PeopleGenerator {
    ...
    private void readData() {
        ...
        try {
            mans.addAll(Files.readAllLines(Paths.get("C:\\Users\\aston\\IdeaProjects\\my projects\\dimploma-mc\\rcsData\\generator\\people\\man-firstnames.txt")));
            womans.addAll(Files.readAllLines(Paths.get("C:\\Users\\aston\\IdeaProjects\\my projects\\dimploma-mc\\rcsData\\generator\\people\\woman-firstnames.txt")));
            lastnames.addAll(Files.readAllLines(Paths.get("C:\\Users\\aston\\IdeaProjects\\my projects\\dimploma-mc\\rcsData\\generator\\people\\lastnames.txt")));
        } catch (IOException e) {
